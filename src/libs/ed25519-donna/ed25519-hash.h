...
#define S0(x) \
  (sha512_ROTR64(x, 28) ^ sha512_ROTR64(x, 34) ^ sha512_ROTR64(x, 39))
#define S1(x) \
  (sha512_ROTR64(x, 14) ^ sha512_ROTR64(x, 18) ^ sha512_ROTR64(x, 41))
...
static void ed25519_hash_update(sha512_state* S,
                                const uint8_t* in,
                                size_t inlen)
{
  size_t blocks, want;
