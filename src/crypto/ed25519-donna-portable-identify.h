...
#define CPU_X86 300
    ...
    defined(_M_IA64) || defined(__ia64)
#define CPU_IA64
#endif
...
#if defined(powerpc) || defined(__PPC__) || defined(__ppc__) ||         \
    defined(_ARCH_PPC) || defined(__powerpc__) || defined(__powerpc) || \
...
/* 64 bit cpu */
#if defined(CPU_X86_64) || defined(CPU_IA64) || defined(CPU_SPARC64) || \
