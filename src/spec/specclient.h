...
{
    public:
        SpecClient(jsonrpc::IClientConnector &conn, jsonrpc::clientVersion_t type = jsonrpc::JSONRPC_CLIENT_V2) : jsonrpc::Client(conn, type) {}

        int getData(const std::string& arg1, int arg2) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["arg1"] = arg1;
            p["arg2"] = arg2;
        ...
        void tellServer(const Json::Value& arg3, bool arg4) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["arg3"] = arg3;
            p["arg4"] = arg4;
